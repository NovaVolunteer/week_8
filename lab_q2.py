...
# a log transformation because price is always positive. The number of seats in the car is also 
# badly skewed (most have 5), so we can do a log transformation on this too. Since Make_year only 
